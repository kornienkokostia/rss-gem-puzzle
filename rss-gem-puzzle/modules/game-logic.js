    ...
    piecesArr.map(el => {
        el.addEventListener('click', (e) => {
            ...
            if (clickedPiece === emptyPiece - 1) {
                ...
                piecesArr[clickedPiece].style.transform = `translateX(${65/fieldSize}vh)`
                piecesArr[emptyPiece].style.transform = `translateX(-${65/fieldSize}vh)`
                setTimeout(() => {
            ...
            if (emptyPiece === clickedPiece + fieldSize) {
                ...
                turnOffFieldClick()
                playAudio ? audio.play() : false
                piecesArr[clickedPiece].style.transform = `translateY(${65/fieldSize}vh)`
                piecesArr[emptyPiece].style.transform = `translateY(-${65/fieldSize}vh)`
                setTimeout(() => {
